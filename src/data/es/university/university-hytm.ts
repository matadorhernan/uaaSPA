  ...
  sections: [
    {
      ...
      image: {
        path:
          'https://www.uaa.mx/portal/wp-content/uploads/2018/10/Himno-Universitario-1024x561.jpg',
        alt: 'Concierto de Inauguración del Centro de Información de la UAA ',
        caption:
          'Concierto de Inauguración del Centro de Información en el año de 1976, ante la presencia del presidente de la República Mexicana, Luis Echeverría Álvarez',
      },
      text:
    ...
    {
      sectionType: 'quote-section',
      text:
        '¡SE LUMEN PROFERRE!</br></br>UNIVERSITAS, UNIVERSITAS</br></br>Sé luz que brille</br></br>con gran intensidad</br></br>luz que irradie</br></br>con libertad.</br></br>Sé luz que crezca</br></br>en bien de los demás</br></br>luz que transforme</br></br>la humanidad.</br></br>Tus ideales serán verdad</br></br>si decidido lanzas tu afán.</br></br>Sé luz que a todos</br></br>dé lo que debe dar</br></br>luz de justicia</br></br>y de igualdad.</br></br>Sé luz de joven</br></br>dinámico y audaz</br></br>luz que se extienda</br></br>por dar la paz.</br></br>¡SE LUMEN PROFERRE!</br></br>UNIVERSITAS, UNIVERSITAS',
      title: 'Letra y música:',
      name: 'Óscar Malo Flores',
    },
  ],
};
